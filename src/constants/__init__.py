...
"""
DATA_INGESTION_COLLECTION_NAME: str = "Housing-Data"
...
MODEL_TRAINER_N_ESTIMATORS= 104
MODEL_TRAINER_MIN_SAMPLES_SPLIT: int = 2
MODEL_TRAINER_MIN_SAMPLES_LEAF: int = 3
MODEL_TRAINER_MAX_FEATURES: int = 0.5
...
MODEL_BUCKET_NAME = "housing-data-storage2026"
